...
function buildUpdateDocument() {
    ...
    document.updatedValues = {};
    document.updatedValues.value = $(this.valText).val();
    document.updatedValues.cache_lifetime = $(this.cacheText).val();
    document.updatedValues.eff_date = $(this.effDateText).val();
    document.updatedValues.end_date = $(this.endDateText).val();
