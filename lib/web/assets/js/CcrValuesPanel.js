...
function buildUpdateDocument() {
    var document = {};
    document._id = $(this.settingId).val();
    document.value = $(this.valText).val();
    document.cache_lifetime = $(this.cacheText).val();
    document.eff_date = $(this.effDateText).val();
    document.end_date = $(this.endDateText).val();
    return document;
};
