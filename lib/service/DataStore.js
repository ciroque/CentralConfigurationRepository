...
DataStore.prototype.updateSetting = function(update_params, handler) {
    ...
    var new_doc = {
       key : {
           environment : update_params.originalDocument.key.environment,
           application : update_params.originalDocument.key.application,
           scope : update_params.originalDocument.key.scope,
           setting : update_params.originalDocument.key.setting
       },
       value : update_params.updatedValues.value,
       temporalization : {
           cache_lifetime : update_params.updatedValues.cache_lifetime,
           eff_date : update_params.updatedValues.eff_date,
           end_date : update_params.updatedValues.end_date,
       }
    };
