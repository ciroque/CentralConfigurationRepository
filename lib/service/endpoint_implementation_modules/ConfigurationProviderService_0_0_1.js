    ...
    this.data_store.retrieveActiveSetting(
        ...
        function(err, settings) {
            if(err != null) {
                ...
                self.log_writer.writeDebug('(&ConfigurationProviderService_0_0_1::handleRequest&)[data_store.retrieveActiveSetting]::cout => ' + count);
                ...
                if(count == 0) {
                    ...
                    if(all_parameters_provided) {
                        ...
                        var index = findSettingToSend(settings, req.params.environment, self.default_environment);
