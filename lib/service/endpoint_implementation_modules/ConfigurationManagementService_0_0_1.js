...
ConfigurationManagementService_0_0_1.prototype.handlePut = function(req, res) {
    this.log_writer.writeDebug('(&ConfigurationManagementService_0_0_1::handlePut&) => ' + JSON.stringify(req.params));
    res.header('x-ccr-params', JSON.stringify(req.params));
    res.send(200, 'whaaaaaaaa??');
    res.end();
};
