...
function ConfigurationManagementService_0_0_1(data_store, log_writer, access_stats_tracker, settings) {
    this.routes = [
        {
            verb : 'put',
            path : '/ccr/schedule/:environment/:application/:scope/:setting',
        ...
        {
            verb : 'get',
            path : '/ccr/schedule/:environment',
            handler : this.handleGet
        },
        {
            verb : 'get',
            path : '/ccr/schedule/:environment/:application',
            handler : this.handleGet
        },
        {
            verb : 'get',
            path : '/ccr/schedule/:environment/:application/:scope',
            handler : this.handleGet
        },
        {
            verb : 'get',
