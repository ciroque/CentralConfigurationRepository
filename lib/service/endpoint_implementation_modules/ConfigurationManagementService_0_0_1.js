    ...
    validator.validateSettingDocument(
        ...
        function(err, validated_document) {
            if(err !== null) {
                ...
                // convert to date objects... issue #2
                validated_document.temporalization.eff_date = new Date(validated_document.temporalization.eff_date);
                validated_document.temporalization.end_date = new Date(validated_document.temporalization.end_date);
